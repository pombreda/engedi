var App = function () {
    ...
    function updateHeight() {
        if (!$("#cl-wrapper").hasClass("fixed-menu")) {
            ...
            if ($("#cl-wrapper .nscroller").length)
    ...
    return {
        ...
        init: function (options) {
            ...
            $('body').on('click', '.jarviswidget-toggle-btn', function (e) {
                e.preventDefault();
                $content = $(this).closest('.jarviswidget').find('div[role=content]');
